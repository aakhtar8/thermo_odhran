...
"""
fig, ax = plt.subplots()
plt.title('valve discharge temperture and amount liquified')
# axes object for secondary y-Axis
ax2 = ax.twinx()
ax.plot(x, valve_discharge_temp, color = 'g')
ax2.plot(x, fraction_liquified, color = 'b')
 
# giving labels to the axises
ax.set_xlabel('Iterations', color = 'r')
ax.set_ylabel('throttle temperture (K)', color = 'g')
 
# secondary y-axis label
ax2.set_ylabel('Fraction Liquified(%)', color = 'b')
